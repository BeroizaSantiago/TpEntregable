...
class Aereo extends Viaje{
    ...
    public function __construct($codigoInt, $destino, $cantMaxima, $objResponsable, $importeFlt, $idaOVueltaStr, $numeroVueloInt, $tipoAsientoStr, $nombreAerolineaStr, $cantidadDeEscalasInt){
        parent::__construct($codigoInt, $destino, $cantMaxima, $objResponsable);
